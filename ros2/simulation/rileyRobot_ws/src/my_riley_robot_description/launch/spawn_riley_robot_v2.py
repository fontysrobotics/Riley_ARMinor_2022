...
def main():
    ...
    parser.add_argument('-urdf', '--robot_urdf', type=str, default='riley_robot.urdf',
                        help='Name of the robot to spawn')
    parser.add_argument('-n', '--robot_name', type=str, default='riley_robot',
                        help='Name of the robot to spawn')
    parser.add_argument('-ns', '--robot_namespace', type=str, default='riley_robot_ns',
    ...
    for plugin in root.iter('plugin'):
        ...
        elif 'riley_robot_imu_plugin' in plugin.attrib.values():
            imu_plugin = plugin
